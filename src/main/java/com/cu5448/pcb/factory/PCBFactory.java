...
/**
 * Factory Pattern Implementation using Spring Dependency Injection and Lombok
 * 
 * @RequiredArgsConstructor generates constructor for final fields
 * This factory creates PCB instances with configuration-driven defect rates.
 */
@Component
...
public class PCBFactory {
    ...
    public PCB createPCB(String type) {
        return switch (type.toLowerCase()) {
            ...
            case "sensorboard", "sensor", "sensor board" -> new SensorBoard(pcbProperties.getSensorboard());
            case "gatewayboard", "gateway", "gateway board" -> new GatewayBoard(pcbProperties.getGatewayboard());
