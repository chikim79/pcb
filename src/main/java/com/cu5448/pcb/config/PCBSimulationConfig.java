...
/**
 * Spring Configuration Class implementing Dependency Injection Design Pattern using Lombok
 * 
 * @RequiredArgsConstructor generates constructor for final fields, enabling constructor injection
 * This configuration class demonstrates the Dependency Injection pattern by:
 * 1. Centralizing bean creation and wiring
 * 2. Managing dependencies between components
 * 3. Enabling Spring IoC container to manage object lifecycle
 */
@Configuration
...
public class PCBSimulationConfig {
    ...
    /**
     * Factory Pattern Implementation - Creates PCB instances
     * PCBFactory is already annotated with @Component, so this is optional
     */

    /**
     * Station Factory Methods - Create stations with configured failure rates
     * These are not @Bean methods since stations need different StatisticsCollector instances per simulation
     */
